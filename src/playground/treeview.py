    ...
    def transition_search_icon(self, text):
        ...
        if text:
            ...
            self.search_action.setIcon(
                QtGui.QIcon(QtGui.QPixmap.fromImage(QtGui.QImage("snippets-playground/src/playground/search_icon.gif")))
            )
...
class ContextView(QtWidgets.QWidget):
    def __init__(self) -> None:
        ...
        for parent in range(self.model.rowCount()):
            ...
            parent_icon = QtGui.QIcon(
                QtGui.QPixmap.fromImage(QtGui.QImage("snippets-playground/src/playground/sequence_icon.png"))
            )
            ...
            for child in range(self.model.item(parent).rowCount()):
                ...
                icon = QtGui.QIcon(
                    QtGui.QPixmap.fromImage(QtGui.QImage("snippets-playground/src/playground/shot_icon.png"))
                )
                icon.addPixmap(
                    QtGui.QPixmap.fromImage(QtGui.QImage(":/arrow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off
                )
